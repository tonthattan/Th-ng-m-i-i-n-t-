...
namespace Spice.Areas.Admin.Controllers
{
    ...
    public class MenuItemController : Controller
    {
        ...
        {
            ViewData["Getemployeedetails"] = Product;
            var empquery = from x in _db.MenuItem.Include(m => m.Category).Include(m => m.SubCategory) select x;
            if (!String.IsNullOrEmpty(Product))
            {
                empquery = empquery.Where(x => x.Name.Contains(Product));
