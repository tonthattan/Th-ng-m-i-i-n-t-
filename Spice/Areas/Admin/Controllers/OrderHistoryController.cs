...
namespace Spice.Areas.Customer.Controllers
{
   ...
   // [Area("Customer")]
    public class OrderHistoryController : Controller
    {
        ...
        public OrderHistoryController(ApplicationDbContext db, IEmailSender emailSender)
        {
            _db = db;
        ...
        [Authorize]
        public async Task<IActionResult> OrderHistoryAll(int productPage = 1)
        {
            var claimsIdentity = (ClaimsIdentity)User.Identity;
            var claim = claimsIdentity.FindFirst(ClaimTypes.NameIdentifier);
            ...
            List<OrderHeader> OrderHeaderList = await _db.OrderHeader.Include(o => o.ApplicationUser).OrderBy(o=>o.Id).ToListAsync();
            ...
            foreach (OrderHeader item in OrderHeaderList)
            {
                ...
                {
                    OrderHeader = item,
                    OrderDetails = await _db.OrderDetails.Where(o => o.OrderId == item.Id).OrderBy(o => o.Id).ToListAsync()
                };
            ...
            //    TotalItem = count,
            //     urlParam = "/Admin/OrderHistory/OrderHistoryAll?productPage=:"
