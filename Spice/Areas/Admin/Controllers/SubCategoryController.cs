...
namespace Spice.Areas.Admin.Controllers
{
    ...
    public class SubCategoryController : Controller
    {
        ...
        {
            ViewData["Getemployeedetails"] = SubCategory;
            var empquery = from x in _db.SubCategory.Include(s => s.Category) select x;
            if (!String.IsNullOrEmpty(SubCategory))
            {
                empquery = empquery.Where(x => x.Name.Contains(SubCategory));
        ...
        //    {
        //        return View(await _db.SubCategory.Where(m => m.Name.Contains(Empsearch)).ToListAsync());
