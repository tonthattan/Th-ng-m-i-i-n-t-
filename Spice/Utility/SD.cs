...
namespace Spice.Utility
{
    ...
    {
        public const string DefaultFoodImage = "df.png";


        public const string ManagerUser = "Manager"; //quản lý
        public const string KitchenUser = "WareHouse";    // kiểm tra sp kho hàng
        public const string FrontDeskUser = "FrontDesk";  //quầy giao hàng
